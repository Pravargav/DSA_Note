...
```
-> Rod cutting probelm(instead of cutting rod of length n we connect small pieces into a rod of length n so that it becomes addition of rods of various lengths like unbounded knapsack)
